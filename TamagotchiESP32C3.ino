...
const unsigned long HUNGER_INTERVAL = 10000;
const unsigned long HAPPY_INTERVAL = 15000;
const unsigned long HEALTH_INTERVAL = 12000;

unsigned long lastAnimTick = 0;
unsigned long lastBlinkTick = 0;
const unsigned long ANIM_INTERVAL = 450;
const unsigned long BLINK_INTERVAL = 3500;
const unsigned long BLINK_DURATION = 140;
